...
set_content "VITE_CHAIN_ID" $CHAIN_ID $CLIENT_ENV_FILE "Garnet Chain ID"
set_content "VITE_GATEWAY_HTTP" $API_URL $CLIENT_ENV_FILE "Gateway HTTP URL"
set_content "VITE_GATEWAY_WS" $WS_URL $CLIENT_ENV_FILE "${SERVER} Gateway WebSocket URL"