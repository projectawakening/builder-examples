...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "test2", name: "ItemPrice", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x746274657374320000000000000000004974656d507269636500000000000000);
