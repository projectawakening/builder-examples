...
contract ForwarderSystem is EveSystem {
  ...
  function callOnlyApprovedForwarderPermissioned(uint256 smartObjectId) public hookable(smartObjectId, _systemId()) returns (bytes memory) {
