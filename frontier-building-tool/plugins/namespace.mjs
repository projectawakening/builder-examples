...
export async function execute({ contracts }) {
  ...
  const updates = [
    {
      ...
      pattern: /^bytes14 constant SMART_GATE_DEPLOYMENT_NAMESPACE.*/m,
      replacement: `bytes14 constant SMART_GATE_DEPLOYMENT_NAMESPACE = "${namespace}";`
    },
    {
