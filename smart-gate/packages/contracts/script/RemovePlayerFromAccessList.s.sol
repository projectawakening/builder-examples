...
contract RemovePlayerFromAccessList is Script {
  using SmartGateUtils for bytes14;
  using SmartGateLib for SmartGateLib.World;

  SmartGateLib.World smartGate;

  function run(address worldAddress, uint256 charId, bytes32 accessListId) external {
    ...
    console.log("Player with character ID ", charId);
