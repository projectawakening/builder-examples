...
contract AddAccessListManager is Script {
  ...
  function run(address worldAddress, address newAccessListManager) external {
    ...
    AccessListManager.set(newAccessListManager, true);
    bool hasAccessManagerBeenAdded = AccessListManager.get(newAccessListManager);
    console.log("Access List Manager added:", hasAccessManagerBeenAdded);
